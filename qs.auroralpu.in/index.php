  ...
  <div class="form-group">
    <label class="col-md-12 control-label" for="name"></label>  
    <div class="col-md-12">
    <input id="branch" name="branch" placeholder="Enter your branch" class="form-control input-md" type="text" value="<?php
  ...
  <div class="col-md-3 box">
  <span href="#" data-target="#login" style="color:lightyellow">Organized by Aurora LPU<br><br></span>
  </div>
